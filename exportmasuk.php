...
<div class="container">
    <!-- Pembuatan tabel -->
	<h2>Tabel Stok Sembako Masuk</h2>
		<div class="data-tables datatable-dark">
            <table class="table table-bordered" id="tabelsembakomasuk" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>Tanggal</th>
                        <th>Nama</th>
            ...
            <tbody>
                 <!-- pengisian data pada tabel dengan memanggil nilai variabel dari tabel masuk dan stok -->
                <?php
